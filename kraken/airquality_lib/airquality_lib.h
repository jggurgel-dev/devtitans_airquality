...
class AirQuality {
    public:
         ...
         * Ao executar esse método, o dispositivo AirQuality entra no modo
    ...
    private:
         ...
         * "ldr" ou "threshold" do diretório /sys/kernel/airquality.
         */
         ...
         * conectado, mas a propriedade devtitans.airquality.allow_simulated
         * for true.
         */
